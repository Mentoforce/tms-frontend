...
export default function SearchTicket({
  ...
  return (
    <section
      className="w-full max-w-82 md:max-w-210 mx-auto px-0 mb-20 "
      style={{ color: `${accent}` }}
    >
      {/* SECTION HEADING */}
      <div className="flex flex-col gap-1 mb-6 md:mb-8">
        <h2 className="text-[18px] md:text-[30px] font-semibold md:font-bold uppercase tracking-tight">
          TRANSACTION INQUIRY
        </h2>
        <div
      ...
      <div
        ...
        style={{
          backgroundColor: `${accent}1A`, // 10% opacity for a subtle glass feel
          borderColor: `${accent}`,
        }}
      >
        {!result ? (
